 ...
 */
public class AlarmDeviceProvider extends ContentProvider {

    private final static String AUTHORITY = AlarmDeviceProvider.class.getName();

    private final static String TABLE_NAME = AppDb.AlarmDeviceTable.TABLE_NAME;
    ...
    static {
        ...
        for (String s : AppDb.AlarmDeviceTable.COLUMNS) {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case ITEM:
                ...
                qb.appendWhere(AppDb.AlarmDeviceTable.COLUMN_ID + "=" + uri.getPathSegments().get(1));
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case ITEM:
                ...
                where = AppDb.AlarmDeviceTable.COLUMN_ID + "=" + uri.getPathSegments().get(1);
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case ITEM:
                ...
                cnt = db.update(AppDb.AlarmDeviceTable.TABLE_NAME, values, where, selectionArgs);
