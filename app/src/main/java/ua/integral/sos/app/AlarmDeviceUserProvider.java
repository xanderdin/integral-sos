...
public class AlarmDeviceUserProvider extends ContentProvider {
    ...
    private final static String TABLE_NAME = AppDb.AlarmDeviceUserTable.TABLE_NAME;
    ...
    static {
        ...
        for (String s : AppDb.AlarmDeviceUserTable.COLUMNS) {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case ITEM:
                ...
                qb.appendWhere(AppDb.AlarmDeviceUserTable.COLUMN_ID + "=" + uri.getPathSegments().get(1));
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case ITEM:
                ...
                where = AppDb.AlarmDeviceUserTable.COLUMN_ID + "=" + uri.getPathSegments().get(1);
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case ITEM:
                ...
                cnt = db.update(AppDb.AlarmDeviceUserTable.TABLE_NAME, values, where, selectionArgs);
